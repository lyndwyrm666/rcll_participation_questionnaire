...
\begin{center}
\textbf{\huge The RoboCup Logistics League (RCLL) invites you to join the competition}
\end{center}\vskip1em

\noindent In this questionnaire we want to evaluate factors that keep you from participating in the RCLL competition. Our goal is to make our league more accessible.

\section*{General Background}

\Qitem{ \Qq{Have you heard of Industry 4.0 before?} \hfill \QO{} Yes\hskip1.25cm \QO{} No}
...
\Qitem[c]{ \Qq{If you answered yes to 3a or b:\newline Do you think the RCLL is an interesting competition?} \hfill \QO{} Yes\hskip1.25cm \QO{} No}

\section*{If you are new to RoboCup}

\Qitem{ \Qq{Do you think RoboCup is an interesting concept?} \hfill \QO{} Yes\hskip1.25cm \QO{} No}

\Qitem{ \Qq{What RoboCup Leagues would most likely compete in?}
\begin{Qlist}
...
\Qitem{ \Qq{If you did not choose the Logistics League:\newline Was there a specific reason that you did not choose the Logistics League?} \Qline{3cm}}

\section*{Teams already involved in RoboCup}
...
\Qitem[b]{ \Qq{If you answered yes:\newline What do you feel is the main reason you have not joined yet?} \hfill \Qline{3cm}}\vspace{0.3cm}

\Qitem[c]{ \Qq{If you answered no:\newline What do you feel is missing to make it more interesting for you?} \hfill \Qline{3cm}}\vspace{0.3cm}
...
\subsection*{Teams that already competed in RCLL}

\Qitem[a]{ \Qq{Is there a specific reason why you no longer compete?} \hfill \QO{} Yes\hskip1.25cm \QO{} No}

\Qitem[b]{ \Qq{If you answered yes:\newline What do you feel is the main reason you no longer compete?} \hfill \Qline{3cm}}\vspace{0.3cm}

\Qitem[a]{ \Qq{Do you think about competing again?} \hfill \QO{} Yes\hskip1.25cm \QO{} No}

\Qitem[b]{ \Qq{If you answered yes:\newline How can we help you to pick up the competition again?} \hfill \Qline{3cm}}\vspace{0.3cm}

\Qitem[c]{ \Qq{If you answered no:\newline What do you feel is deterring you the most?} \hfill \Qline{3cm}}\vspace{0.3cm}
